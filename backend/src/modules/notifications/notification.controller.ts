...
export const listGuestNotifications = asyncHandler(async (req: Request, res: Response) => {
  ...
  const notifications = await notificationService.listGuestNotifications(lookupCode);
  res.json(notifications);
});
...
export const markNotificationRead = asyncHandler(async (req: Request, res: Response) => {
  ...
  const notification = await notificationService.markNotificationRead(notificationId, actor);
